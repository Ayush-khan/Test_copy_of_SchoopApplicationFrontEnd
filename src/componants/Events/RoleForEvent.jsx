...
//       setRoleEvent(response.data.data);
//       setPageCount(Math.ceil(response.data.data.length / pageSize));
//     } catch (error) {
//       setError(error.message);
//     } finally {
...
//       ...prevErrors,
//       ...validateRoleForm(newRoleName, value), // pass correct order: name first, id second
//     }));
//   };
...
//   const handleEdit = (role) => {
//     setCurrentRole(role);
//     setNewRoleName(role.name); // This stays from the selected role (School Owner)
//     setNewStatus(role?.is_active);
//     setShowEditModal(true);

//     // Fetch the original role name from your roles API data
//     const originalRole = roles.find((r) => r.role_id === role?.role_id);
//     if (originalRole) {
//       setSelectedRoleId(originalRole.name); // Set the fetched name ("Admin")
//     }
//   };
...
//   // const validateRoleForm = (name, role_id) => {
//   //   const errors = {};
...
//   //     errors.name = "Role Name must not exceed 30 characters.";
//   //   }
...
//   const validateRoleForm = (name, role_id) => {
//     const errors = {};
//     const roleIdStr = String(role_id || "").trim(); // force to string
...
//     const value = e.target.value;
//     setNewRoleName(value); // store the role name correctly
//     setFieldErrors((prevErrors) => ({
//       ...prevErrors,
//       name: validateRoleForm(value, selectedRoleId).name, // match handleSubmitAdd
//     }));
//   };

//   const handleActiveAndInactive = (roleIsPass) => {
//     console.log("handleActiveAndInactive-->", roleIsPass.role_id);
//     const studentToActiveOrDeactive = roleEvent.find(
...
//         `${API_URL}/api/update_activeforevent/${currentStudentDataForActivate?.studentToActiveOrDeactive?.role_id}`,
//         {}, // Empty data object
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
...
//     if (!selectedRoleId || String(selectedRoleId).trim() === "") {
...
//     const validationErrors = validateRoleForm(newRoleName, selectedRoleId);
...
//       await axios.post(
//         `${API_URL}/api/save_rolesforevent`,
//         { name: newRoleName, role_id: selectedRoleId },
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
...
//   //   const validationErrors = validateRoleForm(newRoleName);
//   //   if (Object.keys(validationErrors).length > 0) {
//   //     setFieldErrors(validationErrors);
//   //     setIsSubmitting(false);
//   //     return;
...
//   //     await axios.put(
//   //       `${API_URL}/api/update_rolesforevent/${currentRole.role_id}`,
//   //       {
//   //         name: newRoleName,
//   //       },
//   //       {
...
//   //         formattedErrors.name = errData.errors.name[0];
//   //       }
...
//     // Pass null or empty string for role_id so role_id validation is skipped
//     const validationErrors = validateRoleForm(newRoleName, null);

//     // Remove role_id error if it exists (for edit mode)
//     delete validationErrors.role_id;
...
//     console.log("fdh");
//     const roleToDelete = roleEvent.find((role) => role.role_id === id);
...
//       await axios.delete(
//         `${API_URL}/api/delete_rolesforevent/${currentRole.roleToDelete.role_id}`,
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
...
//   const filteredRoles = roleEvent.filter((role) =>
...
//                         Role Name
//                       </th>
//                       <th className="w-full md:w-[14%] px-2 text-center lg:px-3 py-2 border border-gray-950 text-sm font-semibold text-gray-900 tracking-wider">
//                         Role Id
//                       </th>
...
//                   <div className="  relative  flex justify-center  mx-2 pb-4">
...
//                     <label htmlFor="name" className="w-1/2 mt-2">
...
//                 ></div>
//                 <div className="modal-body w-full md:w-[90%] mx-auto  ">
//                   <div className="  relative  flex justify-center  mx-2 pb-2">
//                     <label htmlFor="role_id" className="w-1/2 mt-2">
//                       Role <span className="text-red-500">*</span>
//                     </label>
//                     <input
...
//                       value={selectedRoleId}
//                       readOnly
//                       style={{ backgroundColor: "#e5e7eb" }} // Tailwind's gray-200
//                     />
//                   </div>
//                   <div className="  relative  flex justify-center  mx-2">
//                     <label htmlFor="name" className="w-1/2 mt-2">
