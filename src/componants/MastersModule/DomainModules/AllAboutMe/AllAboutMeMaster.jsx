...
function AllAboutMeMaster() {
  ...
  const filteredSections = sections.filter((section) => {
    ...
    const parameterName = section?.name?.toLowerCase() || "";
  ...
  const handleSubmitAdd = async () => {
    ...
    try {
      ...
      await axios.post(`${API_URL}/api/save_allaboutmemaster`, formData, {
        headers: {
          Authorization: `Bearer ${token}`,
      ...
      fetchSections();
      handleCloseModal();
      toast.success("All About Me Parameter added successfully!");
    } catch (error) {
  ...
  const handleSubmitEdit = async () => {
    ...
    try {
      const token = localStorage.getItem("authToken");
      if (!token || !currentSection || !currentSection.am_id) {
        throw new Error("No authentication token or section ID found");
      }

      await axios.put(
        `${API_URL}/api/update_allaboutmemaster/${currentSection.am_id}`,
      ...
      fetchSections();
      handleCloseModal();
      toast.success("All about me Parameter updated successfully!");
    } catch (error) {
  ...
  const handleDelete = (id) => {
    const sectionToDelete = sections.find((sec) => sec.am_id === id);
  ...
  const handleSubmitDelete = async () => {
    ...
    try {
      ...
      const response = await axios.delete(
        `${API_URL}/api/delete_allaboutmemaster/${currentSection.am_id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      if (response.data.success) {
        ...
        setShowDeleteModal(false);
        setCurrentSection(null);
        toast.success("All about me Parameter deleted successfully!");
      } else {
                              ...
                              <>
                                ...
                                <td className="text-center px-2 lg:px-3 border border-gray-950 text-sm">
                                  <button
                                    ...
                                    onClick={() => handleDelete(section.am_id)}
                                  >
        ...
        {showEditModal && (
          ...
          >
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                <div className="flex justify-between p-3">
                  <h5 className="modal-title">Edit All About Me Parameter</h5>
                  <RxCross1
                ...
                <div className=" flex justify-end p-3 mr-2">
                  <button
                    type="button"
                    className="btn btn-primary px-3 mb-2 mr-2"
                    style={{}}
          ...
          >
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p>
                    Are you sure you want to delete All About Me Parameter for{" "}
...
export default AllAboutMeMaster;
