...
const SelfAssessment = () => {
  ...
  //       return [
  //         ...prev,
  //         { student_id: studentId, sam_id: samId, value: newValue }, // ✅ use sam_id
  //       ];
  //     }
  //   });
  // };
  ...
  //   // loop through all students & params
  ...
  //       const value =
  //         record?.value ||
  //         student.assessments.find((a) => a.sam_id === param.sam_id)?.value ||
  //         "";

  //       if (!value.trim()) {
  //         const key = `${student.student_id}-${param.sam_id}`;
  //         newErrors[key] = "Please enter data.";

  //         // highlight only the first empty field
  ...
  //         // toast.error("Please fill this student field before publishing");
  //         return; // 🚨 stop here, don’t check other fields
  //       }
  //     }
  //   }
  ...
  const handleSubmitPublish = async () => {
    ...
    // loop through all students & parameters
    // for (const student of timetable) {
    //   for (const param of parameter || []) {
    //     const record = selectedRecords.find(
    //       (rec) =>
    ...
    //       return; // stop publishing on first error
    //     }
    //   }
    // }
    for (const student of timetable) {
  ...
  //       toast.success("Student self assessment unpublish successfully.");
  //       setTimetable([]);
  //       setSelectedRecords([]);
  //       setCheckPublish("");
  //       handleSearch();
