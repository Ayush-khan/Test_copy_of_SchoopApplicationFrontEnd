...
function HPCSubjectList() {
  ...
  const [classes, setClasses] = useState(["Scholastic", "Co-Scholastic"]);
  ...
  const filteredSections = (Array.isArray(sections) ? sections : []).filter(
    (section) =>
      section?.subject_type?.toLowerCase().includes(searchLower) ||
  ...
  const handleEdit = (section) => {
    ...
    console.log("sectionsID for subject", section.hpc_sm_id);
  ...
  const handleSubmitAdd = async () => {
    ...
    try {
      ...
      const checkNameResponse = await axios.post(
        `${API_URL}/api/check_hpc_subject_name`,
      ...
      if (checkNameResponse.data?.exists === true) {
        ...
        // setSubjectTypeError("Subject Type is already taken.");
      ...
      fetchSections();
      handleCloseModal();
      toast.success("HPC Subject added successfully!");
    } catch (error) {
  ...
  const handleSubmitEdit = async () => {
    ...
    try {
      ...
      console.log("This is Edit data ID:", currentSection.hpc_sm_id);

      console.log("This is Edit data Name:", newSectionName);
      console.log("This is Edit data class_id:", newDepartmentId);

      await axios.put(
        `${API_URL}/api/hpcsubject/${currentSection.hpc_sm_id}`,
        { name: newSectionName, subject_type: newDepartmentId },
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      fetchSections();
      handleCloseModal();
      toast.success("HPC Subject updated successfully!");
    } catch (error) {
      ...
      if (error.response && error.response.data.status === 422) {
        ...
        if (errors.name) {
          ...
          errors.name.forEach((err) => toast.error(err));
        }
      } else {
        toast.error("Server error. Please try again later.");
      }
  ...
  const handleDelete = (id) => {
    ...
    const sectionToDelete = sections.find((sec) => sec.hpc_sm_id === id);
  ...
  const handleSubmitDelete = async () => {
    ...
    try {
      ...
      if (!token || !currentSection || !currentSection.hpc_sm_id) {
      ...
      if (response.data.success) {
        ...
        toast.error(response.data.message || "Failed to delete HPC Subject");
      }
    } catch (error) {
                              ...
                              <>
                                ...
                                <td className="text-center px-2 lg:px-3 border border-gray-950 text-sm">
                                  <button
                                    ...
                                    onClick={() =>
                                      handleDelete(section.hpc_sm_id)
                                    }
                                  >
              ...
              >
                <div className="modal-content">
                  <div className="flex justify-between p-3">
                    <h5 className="modal-title">Create New HPC Subject</h5>
                    <RxCross1
                  ...
                  <div className="modal-body">
                    <div className=" relative mb-3 flex justify-center  mx-4">
                      <label htmlFor="sectionName" className="w-1/2 mt-2">
                        HPC Subject Name <span className="text-red-500">*</span>
                      </label>
                      <input
                        type="text"
                        maxLength={50}
        ...
        {showEditModal && (
          ...
          >
            ...
            >
              <div className="modal-content">
                <div className="flex justify-between p-3">
                  <h5 className="modal-title">Edit HPC Subject</h5>
                  <RxCross1
          ...
          >
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p>
                    Are you sure you want to delete HPC Subject:{" "}
                    {currentSection?.name}?
                  </p>
                </div>
                <div className=" flex justify-end p-3">
