...
const TeacherPendingIdCardReport = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_URL}/api/get_pendingteacheridcardreport`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
      console.log("Staff pending id card report", response);
      if (!response?.data?.data || response?.data?.length === 0) {
        toast.error("Staff pending id card report data not found.");
        setTimetable([]);
      } else {
      ...
      console.error("Error fetching Staff pending id card Report:", error);
      toast.error(
        "Error fetching Staff pending id card report. Please try again."
      );
    } finally {
  ...
  const handlePrint = () => {
    const printTitle = `Staff pending id card report`;
        ...
        <table class="min-w-full leading-normal table-auto border border-black mx-auto mt-2">
          <thead>
            <tr class="bg-gray-100">
              ...
              <th class="px-2 py-2 border border-black">Emergency Phone No.</th>
  ...
  const handleDownloadEXL = () => {
    ...
    const fileName = `Staff_Pending_Id_Card_Report.xlsx`;
              ...
              <div className="w-full">
                <div className="card mx-auto lg:w-full shadow-lg">
                  ...
                  {timetable.length > 0 ? (
                        ...
                        <table className="min-w-full w-[2300px] leading-normal table-auto">
                          <thead>
                            <tr className="bg-gray-100">
                              <th className="w-12 px-2 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Sr No.
                              </th>
                              <th className="w-44 px-3 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Name
                              </th>
                              <th className="w-28 px-3 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Date of Birth
                              </th>
                              <th className="w-28 px-3 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Date of Joining
                              </th>
                              <th className="w-20 px-2 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Gender
                              </th>
                              <th className="w-24 px-2 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Blood Group
                              </th>
                              <th className="w-36 px-3 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Designation
                              </th>
                              <th className="w-32 px-3 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Contact No.
                              </th>
                              <th className="w-32 px-3 py-2 text-center border border-gray-950 text-sm font-semibold">
                              ...
                              <th className="w-64 px-4 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Address
                              </th>
                              <th className="w-64 px-4 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Permanent Address
                              ...
                              <th className="w-32 px-4 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Academic Qualification
                              </th>
                              <th className="w-40 px-4 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Professional Qualification
                              </th>
                              <th className="w-32 px-3 py-2 text-center border border-gray-950 text-sm font-semibold">
                                Training Status
                    ...
                    <div className="text-center text-xl text-red-700 mt-10 mb-5">
                      Oops! No data found..
                    </div>
                  )}
                </div>
...
export default TeacherPendingIdCardReport;
