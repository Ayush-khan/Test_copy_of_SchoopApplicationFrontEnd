...
const RelgWiseStudRepo = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_URL}/api/get_religionwisestudentreport`,
        {
          headers: { Authorization: `Bearer ${token}` },
          params,
        }
      ...
      if (!response?.data?.data || response?.data?.data?.length === 0) {
        toast.error("Religionwise Student Report data not found.");
        setTimetable([]);
      } else {
      ...
      console.error("Error fetching Religionwise Student Report:", error);
      toast.error(
        "Error fetching Religionwise Student Report. Please try again."
      );
    } finally {
  ...
  const handlePrint = () => {
    const printTitle = `Religionwise Student Report ${
 ...
 <div id="tableHeading" class="text-center w-3/4">
  ...
  const handleDownloadEXL = () => {
    ...
    const headers = ["Sr No.", "Class", "Religion", "No. of Students"];
    ...
    const fileName = `Religionwise_Student_Report_${
      selectedStudent?.label
        ? `List of Class-${selectedStudent?.label}`
        : "For ALL Students"
    }.xlsx`;
  ...
  const filteredSections = timetable.filter((student) => {
    ...
    const category = student?.religion?.toLowerCase() || "";
                ...
                <div className="w-full  mt-4">
                  <div className="card mx-auto lg:w-full shadow-lg">
                    <div className="p-2 px-3 bg-gray-100 border-none flex justify-between items-center">
                      <div className="w-full   flex flex-row justify-between mr-0 md:mr-4 ">
                        <h3 className="text-gray-700 mt-1 text-[1.2em] lg:text-xl text-nowrap">
                          List Of Religionwise Student Report
                        </h3>
                    ...
                    {/* <div className="w-full flex justify-center">
                          <table className="min-w-fit leading-normal table-auto border border-gray-300">
                            <thead>
                              <tr className="bg-gray-100">
                                {[
                                  ...
                                  let columnWidths = "min-w-[160px]";
                                  if (header === "Sr No.")
                                    columnWidths = "min-w-[60px]";
                                  else if (header === "No. of Students")
                                    columnWidths = "min-w-[170px]";
                            ...
                            <tbody>
                              {displayedSections.length ? (
                                ...
                                <tr>
                                  <td
                                    colSpan={4}
                                    className="py-6 text-center text-red-700 text-xl"
                                  >
                                    Oops! No data found..
                                  </td>
                                </tr>
...
export default RelgWiseStudRepo;
