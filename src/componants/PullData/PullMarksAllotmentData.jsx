  ...
  const handlePull = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_URL}/api/marks_pull_allotment`,
        params,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      ...
      if (status === true) {
        toast.success(message || "Marks Allotment Data pulled successfully.");
            ...
            >
              <div className="flex flex-col gap-y-6">
                <div className="flex flex-col md:flex-row gap-4">
                  <label className="w-full md:w-[35%] text-md font-medium">
                    Exam From <span className="text-red-500">*</span>
                  </label>
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  <label className="w-full md:w-[35%] text-md font-medium">
                    Exam To <span className="text-red-500">*</span>
                  </label>
...
export default PullMarksAllotmentData;
