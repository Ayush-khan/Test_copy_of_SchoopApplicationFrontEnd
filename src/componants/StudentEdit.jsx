                      ...
                      <div className="col-md-3 mb-2">
                        ...
                        <div>
                          <input
                            ...
                            name="has_spectacles"
                            value="true"
                            checked={formData.has_spectacles}
                            onChange={() =>
                              setFormData({ ...formData, has_spectacles: true })
                            }
                          />
                          <label htmlFor="has_spectacles_yes" className="mr-2">
                            Yes
                          </label>
                          <input
                            type="radio"
