...
const CreatePercentageCertificate = () => {
  ...
  //       }));
  //       // Reset marks for this id if the input is cleared

  //       return;
  //     }

  //     // Check if the value contains fewer than 3 characters
  ...
  //     // Clear error if value is valid (exactly 3 characters)
  //     setErrors((prevErrors) => ({
  //       ...prevErrors,
  //       [id]: "",
  //     }));
