...
function ApproveStatoinery() {
  ...
  console.log("the response of the approve leave ", staffs);
  ...
  return (
    <>
      <ToastContainer />
      <div className="md:container w-full md:w-[70%] md:mx-auto md:mt-4">
...
export default ApproveStatoinery;
