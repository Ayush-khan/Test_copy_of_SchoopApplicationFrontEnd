...
const GenerateBarcode = () => {
  ...
  return (
    <div
      className={`transition-all duration-500 mx-auto p-4 ${
      ...
      <div className="card rounded-md">
        {!showStudentReport && (
          <>
            ...
            <div
              className="relative w-[98%] -top-6 h-1 mx-auto"
            ...
            {timetable.length === 0 && !loadingForSearch && (
              <div className="md:absolute md:right-2 md:top-[40%] mb-5 text-gray-500">
                <div className="mx-auto w-fit px-2 py-1 bg-blue-50 border border-blue-300 text-blue-800 text-sm rounded flex items-center gap-2">
                  <FaInfoCircle />
                  <span>
                    Please enter accession no range. Click on the <b>Browse</b>{" "}
        ...
        <div className="w-full flex flex-col md:flex-row gap-x-2 p-2 mt-3">
          <div className="w-full flex flex-col md:flex-row gap-4">
            <div className="w-full md:w-[50%] flex flex-col md:flex-row items-center gap-2">
              <label className="w-full md:w-[60%] text-md">
                Accession No. From <span className="text-red-500">*</span>
              </label>
            ...
            <div className="flex items-end">
              <button
                onClick={handleSearch}
                disabled={loadingForSearch}
                className={`h-10 px-4 py-2  text-white font-bold rounded ${
                  loadingForSearch ? "opacity-50 cursor-not-allowed" : ""
                }`}
                style={{ backgroundColor: "#2196F3" }}
              >
          ...
          {timetable.length > 0 && (
            <div className="flex gap-2 items-end bg-gray-100 p-2 mt-2 md:mt-0">
              <input
                type="text"
                placeholder="Search"
                onChange={(e) => setSearchTerm(e.target.value)}
          ...
          <div className="w-full px-4 mt-4 mb-4">
            <div className="card shadow-lg">
              <div className="card-body">
                <h4 className="text-center font-semibold mb-4 bg-gray-100 py-2 px-4 rounded-md shadow-sm">
                  List of Barcode
                </h4>
