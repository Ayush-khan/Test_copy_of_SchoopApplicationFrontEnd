...
const BooksNonReturnReport = () => {
  ...
  const handleSearch = async ({ clearAll = false } = {}) => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_URL}/api/library/book_non_return_report`,
        {
          headers: { Authorization: `Bearer ${token}` },
          params,
  ...
  const handleDownloadEXL = () => {
    ...
    const fileName = `Books Non Return Report.xlsx`;
...
export default BooksNonReturnReport;
