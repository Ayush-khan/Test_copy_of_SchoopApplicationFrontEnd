          ...
          <div className="modal-body">
            <div className="relative mb-4 flex justify-center mx-4">
              ...
              <Select
                id="staffName"
                options={staffNames}
                value={staffNames.find((staff) => staff.value === newStaffName)}
            ...
            <div className="relative mb-4 flex justify-center mx-4">
              ...
              <Select
                id="staffName"
                options={allClasses}
                value={allClasses.find((staff) => staff.value === newClassName)}
...
export default CreateAppointmentWindow;
