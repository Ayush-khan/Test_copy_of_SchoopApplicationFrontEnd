...
const ForgotPassword = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full  bg-gray-200 mb-4 h-4" />

      {/* Forgot Password Box */}
      <div className="bg-white border shadow-lg w-full max-w-md p-6 rounded-md">
        ...
        <form className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">
              <span className="text-red-600">*</span> Please enter your user id
            </label>
            <input
              type="text"
              value={userId}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">
              <span className="text-red-600">*</span> Your child's Date Of Birth
            </label>
            <input
              type="date"
              value={dob}
